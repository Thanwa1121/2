...
""")
	print ("")
	print ("CREDIT : เอฟวันก๊อตคนหล่อคนเดิม")
...
def API_14(): # QCLONE
	try:
		...
		if str(jun) in str(req.text):
			...
			print("\033[92m [ เอฟวันก๊อต ] {phone}")
	except: pass
...
def API_15():
	try:
		...
		if str(jun) in str(req.text):
			print("\033[92m [ เอฟวันก๊อต ]  ERROR HACKER")
		else:
			print("\033[92m [ เอฟวัน ]  ERROR HACKER")
	except: pass
